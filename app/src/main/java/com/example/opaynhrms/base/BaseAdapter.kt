package com.ieltslearning.base
...
import com.example.opaynhrms.extensions.inflate
import com.ieltslearning.listner.RecycleItemViewCallback


abstract class BaseAdapter<T>(@LayoutRes private val view: Int) : RecyclerView.Adapter<BaseAdapter.IViewHolder>() {
