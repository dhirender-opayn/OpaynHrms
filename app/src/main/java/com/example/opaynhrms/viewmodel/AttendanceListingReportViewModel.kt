...
class AttendanceListingReportViewModel(application: Application) : AppViewModel(application), FilterListner,
    View.OnClickListener {
    private lateinit var binder: FragmentAttendaceListingReportBinding
    ...
    fun setBinder(binder: FragmentAttendaceListingReportBinding, baseActivity: KotlinBaseActivity)
    {
        this.binder = binder
   ...
   private fun setadapter(){
       ...
       binder.rvAttendenceReport.adapter = attendaceListingReportView
   }
