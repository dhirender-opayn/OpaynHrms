...
import com.example.opaynhrms.adapter.PaySlipReportingAdminAdapter
...
class PaySlipReportingAdminViewModel(application: Application) : AppViewModel(application),FilterListner,
    View.OnClickListener {
    private lateinit var binder: FragmentPayslipReportingAdminBinding
    ...
    fun setBinder(binder: FragmentPayslipReportingAdminBinding, baseActivity: KotlinBaseActivity)
    {
        this.binder = binder
    ...
    private fun setadapter(){
        val paySlipReportingAdminAdapterView = PaySlipReportingAdminAdapter(baseActivity){

        }
        binder.rvPaySlipReporting.adapter = paySlipReportingAdminAdapterView
    }
